...
export default function TambahPemasukanPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.jenis) {
      toast.error("Pilih jenis pemasukan");
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/koperasi/pemasukan`,
        {
          method: "POST",
          credentials: "include",
          body: formDataToSend,
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs lg:text-sm text-zinc-600">
            Tambahkan pemasukan koperasi (Simpanan / Penyertaan Modal)
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="SIMPANAN_POKOK" className="text-xs lg:text-sm">
                    Simpanan Pokok
                  </SelectItem>
                  <SelectItem value="SIMPANAN_WAJIB" className="text-xs lg:text-sm">
                    Simpanan Wajib
                  </SelectItem>
                  <SelectItem value="SIMPANAN_SUKARELA" className="text-xs lg:text-sm">
                    Simpanan Sukarela
                  </SelectItem>
